-- =============================================
-- 6. Write an SQL query to find for each user, the join date and the number of orders
...
WITH Buyer AS (
    ...
    FROM Users AS u
    JOIN Orders AS o ON u.user_id = o.buyer_id
...
FROM Users AS u LEFT JOIN Buyer AS b ON u.user_id = b.buyer_id;